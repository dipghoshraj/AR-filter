    ...
    v("drawConnectors", function(a, c, b, d) {
        ...
        if (c && b) {
            ...
            for (var g = b.next(); !g.done; g = b.next()) {
                ...
                g = c[k[0]];
                k = c[k[1]];
                g && k && (void 0 === g.visibility || g.visibility > d.visibilityMin) && (void 0 === k.visibility || k.visibility > d.visibilityMin) && (a.fillStyle = y(b.fillColor, {
                    index: e,
                    from: f
                }),
                a.strokeStyle = y(d.color, {
                    index: f,
                    from: g,
                    to: k
                }),
